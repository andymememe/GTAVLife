...
namespace GTAVLife.Helper
{
    public class ScriptTerminator
    {
        ...
        {
            foreach (string gameplayScript in gameplayScripts)
            {
                Function.Call(Hash.TERMINATE_ALL_SCRIPTS_WITH_THIS_NAME, gameplayScript);
            }
        }

        private static readonly List<string> gameplayScripts = new List<string>
        {
            "abigail1",
            "abigail2",
